...
public class Categories {
    ...
    static {
        ...
        for (int i=0; i<c.length(); i++) {
            ...
            CATEGORIES.put(Character.toString(ch), ip);
        }


    }

	public final static IntPredicate ESCAPE_s = new IntSetPredicate(IntArraySet.make(new int[]{9, 10, 13, 32}, 4));
	...
	public final static IntPredicate ESCAPE_i = new IntPredicate() {
		...
		public boolean matches(int value) {
			return value == ':' || XMLCharacterData.isNCNameStart11(value);
		}
	};
	...
	public final static IntPredicate ESCAPE_c = new IntPredicate() {
		...
		public boolean matches(int value) {
			return value == ':' || XMLCharacterData.isNCName11(value);
		}
	};
