...
public class QueryResult {
    ...
    public static final String RESULT_NS = "http://saxon.sf.net/xquery-results";
     ...
     * @since 8.9
     */
	public static void serializeSequence(SequenceIterator iterator, Configuration config, OutputStream destination,
		Properties outputProps) throws XPathException {
     ...
     * @since 8.9
     */
	public static void serializeSequence(SequenceIterator iterator, Configuration config, Writer writer,
		Properties outputProps) throws XPathException {
     ...
     * @since 9.0
     */
	public static void serializeSequence(SequenceIterator iterator, Configuration config, Result result,
    ...
    public static void rewriteToDisk(NodeInfo doc, Properties outputProperties, boolean backup, PrintStream log)
        ...
        try {
        	...
        	LOGGER.error("SystemId of updated document is not a valid URI: " + uri, e);
        ...
        if (!existingFile.exists()) {
            ...
            try {
            	...
            	LOGGER.error("Failed to create new file " + existingFile, e);
