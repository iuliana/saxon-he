        ...
        for (int i=node.arcs.size()-1; i>=0; i--) {
            ...
            switch (thisArc.getAxis()) {
                ...
                case AxisInfo.PARENT: {
                    ...
                    if (grandParent != null && (lastAxis == AxisInfo.CHILD || lastAxis == AxisInfo.ATTRIBUTE || lastAxis == AxisInfo.NAMESPACE)) {
                        ...
                        node.arcs.remove(i);
                    } else if (grandParent != null && lastAxis == AxisInfo.DESCENDANT) {
