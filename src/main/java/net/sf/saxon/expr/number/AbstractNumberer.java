...
public abstract class AbstractNumberer implements Numberer, Serializable {
    ...
    public String format(long number,
        ...
        switch (formchar) {
            ...
            case '\u2460':
                ...
                return Character.toString((char) (0x2460 + number - 1));
            ...
            case '\u2474':
                ...
                return Character.toString((char) (0x2474 + number - 1));
            ...
            case '\u2488':
                ...
                return Character.toString((char) (0x2488 + number - 1));
    ...
    public String toJapanese(long number) {
        ...
        if (number == 0) {
            ...
            fsb.append(Long.toString(number));
        }
        return fsb.toString();
    }
