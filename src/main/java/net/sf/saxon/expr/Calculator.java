...
public abstract class Calculator implements Serializable {
     ...
     */
    protected static final Calculator[] ANY_ANY = {
        new AnyPlusAny(),
        new AnyMinusAny(),
        new AnyTimesAny(),
        new AnyDivAny(),
     ...
     */
    protected static final Calculator[] DOUBLE_DOUBLE = {
    ...
    protected static final Calculator[] DOUBLE_FLOAT = DOUBLE_DOUBLE;
    protected static final Calculator[] DOUBLE_DECIMAL = DOUBLE_DOUBLE;
    //public final static Calculator[] DOUBLE_PDECIMAL = DOUBLE_DOUBLE;
    protected static final Calculator[] DOUBLE_INTEGER = DOUBLE_DOUBLE;

    /**
     * Calculators used when the first operand is a float
     */
    protected static final Calculator[] FLOAT_DOUBLE = DOUBLE_DOUBLE;
    protected static final Calculator[] FLOAT_FLOAT = {
        new FloatPlusFloat(),
        new FloatMinusFloat(),
        new FloatTimesFloat(),
        new FloatDivFloat(),
    ...
    protected static final Calculator[] FLOAT_DECIMAL = FLOAT_FLOAT;
    //public final static Calculator[] FLOAT_PDECIMAL = FLOAT_FLOAT;
    protected static final Calculator[] FLOAT_INTEGER = FLOAT_FLOAT;

    /**
     * Calculators used when the first operand is a decimal
     */
    protected static final Calculator[] DECIMAL_DOUBLE = DOUBLE_DOUBLE;
    protected static final Calculator[] DECIMAL_FLOAT = FLOAT_FLOAT;
    protected static final Calculator[] DECIMAL_DECIMAL = {
    ...
    protected static final Calculator[] DECIMAL_INTEGER = DECIMAL_DECIMAL;

    /**
     * Calculators used when the first operand is an integer
     */
    protected static final Calculator[] INTEGER_DOUBLE = DOUBLE_DOUBLE;
    protected static final Calculator[] INTEGER_FLOAT = FLOAT_FLOAT;
    protected static final Calculator[] INTEGER_DECIMAL = DECIMAL_DECIMAL;
    protected static final Calculator[] INTEGER_INTEGER = {
...
//    };
   // public final static Calculator[] PDECIMAL_DECIMAL = PDECIMAL_PDECIMAL;
     ...
     */
    protected static final Calculator[] DATETIME_DATETIME = {
        null,
     ...
     */
    protected static final Calculator[] DATETIME_DURATION = {
     ...
     */
    protected static final Calculator[] DURATION_DATETIME = {
     ...
     */
    protected static final Calculator[] DURATION_DURATION = {
     ...
     */
    protected static final Calculator[] DURATION_NUMERIC = {
        null, null,
     ...
     */
    protected static final Calculator[] NUMERIC_DURATION = {
        null, null,
