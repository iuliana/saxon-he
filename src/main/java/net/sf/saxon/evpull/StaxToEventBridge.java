...
public class StaxToEventBridge implements EventIterator, SaxonLocator, SourceLocationProvider {
	...
	private static final Logger LOGGER = Logger.getLogger(StaxToEventBridge.class);
    ...
    public PullEvent next() throws XPathException {
        ...
        if (currentEvent instanceof EndDocumentEvent) {
            try {
                ...
                LOGGER.error("Could not close XMLStreamReader", e);
            }
            return null;
        }
        try {
    ...
    private PullEvent translate(int event) throws XPathException {
            ...
            switch (event) {
                ...
                case XMLStreamConstants.COMMENT: {
                    ...
                    CharSlice value = new CharSlice(reader.getTextCharacters(), reader.getTextStart(), reader.getTextLength());
                    o.setStringValue(value);
                    return o;
                }
		...
		for (int i = 0; i < unparsedEntities.size(); i++) {
            ...
            if (ent instanceof EntityDeclaration) {
                ...
                try {
                    ...
                    LOGGER.error("Could not obtains unparsed entities", e);
                }
            }
            if (name != null) {
                try {
