...
public final class YearMonthDurationValue extends DurationValue implements Comparable {
    ...
    public DurationValue multiply(double n) throws XPathException {
        ...
        double product = n * m;
        if (product > Integer.MAX_VALUE || product < Integer.MIN_VALUE || Double.isInfinite(product)) {
    ...
    public DurationValue add(DurationValue other) throws XPathException {
        if (other instanceof YearMonthDurationValue) {
			return fromMonths(getLengthInMonths() + ((YearMonthDurationValue) other).getLengthInMonths());
        } else {
	...
	public int compareTo(Object other) {
		if (other instanceof YearMonthDurationValue) {
			...
			throw new ClassCastException(
				"Cannot compare a yearMonthDuration to an object of class " + other.getClass());
		}
	}
