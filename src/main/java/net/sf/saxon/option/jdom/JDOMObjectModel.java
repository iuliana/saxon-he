...
public class JDOMObjectModel extends TreeModel implements ExternalObjectModel, Serializable {
    ...
    public Builder makeBuilder(PipelineConfiguration pipe) {
        return new JDOMWriter(pipe);
    }

    public int getSymbolicValue() {
        return Builder.JDOM_TREE;
    }
   ...
   /*@Nullable*/ private Object convertXPathValueToObject(Sequence value, Object targetClass) {
    ...
    public DocumentInfo wrapDocument(Object node, String baseURI, Configuration config) {
        ...
        return new JDOMDocumentWrapper(documentNode, baseURI, config);
    }
    ...
    public NodeInfo wrapNode(DocumentInfo document, Object node) {
        return ((JDOMDocumentWrapper)document).wrap(node);
    }
